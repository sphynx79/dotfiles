...
function s:makeDefaultBehavior()
  ...
  call add(behavs.ruby, {
   ...
   call add(behavs.ruby, {
        \   'command': "\<c-x>\<c-u>",
        \   'completefunc' : 'eclim#ruby#complete#CodeComplete',
        \   'meets'   : 'acp#meetsForRubyOmni',
        \   'repeat'  : 0,
        \ })
  "---------------------------------------------------------------------------
...
call l9#defineVariableDefault('g:acp_nextItemMapping', ['<Down>', '\<lt>Down>'])
call l9#defineVariableDefault('g:acp_previousItemMapping', ['<UP>', '\<lt>UP>'])
